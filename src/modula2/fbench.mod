(*
    ...
    This program was implemented in November 2017 and tested
    with GNU Modula-2 1.6.4/GCC 6.4.0.
...
FROM RealMath IMPORT sin, cos, tan, arcsin;
...
VAR
    ...
    ray_height          : REAL;
    axis_slope_angle    : REAL;
    from_index          : REAL;
    to_index            : REAL;

    spectral_line       : ARRAY[0..8] OF REAL;
    od_sa               : ARRAY[0..1], [0..1] OF REAL;
    WyldLens            : ARRAY[0..3], [0..3] OF REAL;
    surf                : ARRAY[0..max_surfaces - 1], [0..4] OF REAL;
...
VAR
    iang                 : REAL;      (*  Incidence angle  *)
    rang                 : REAL;      (*  Refraction angle  *)
    iang_sin             : REAL;      (*  Incidence angle sin  *)
    rang_sin             : REAL;      (*  Refraction angle sin  *)
    old_axis_slope_angle : REAL;
    sagitta              : REAL;
BEGIN
...
BEGIN
    ...
    FOR i := 0 TO current_surfaces - 1 DO
        ...
        IF to_index > 1.0 THEN
            to_index := to_index +
                ((spectral_line[D_line] - spectral_line[line]) /
    ...
    *)
    ...
    FOR itercount := 1 TO niter DO
        ...
        FOR incidence := marginal TO paraxial DO
            ...
            od_sa[incidence, 0] := object_distance;
            od_sa[incidence, 1] := axis_slope_angle;
        END;
