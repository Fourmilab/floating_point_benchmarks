"""
    ...
    Updated for compatibility with Python 3 and tested with
    Python 3.5.2 in November 2017.
"""

import sys, locale, math, string
...
print("\nPress return to begin benchmark: ", end="")
sys.stdout.flush()
sys.stdin.readline()
